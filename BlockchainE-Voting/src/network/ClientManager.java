 ...
 *
 *
 * ClientManager - It is responsible for all the network communications at client side
 *
...
public class ClientManager extends  NetworkManager{
    ...
    public void startClient(){
        ...
        System.out.println("Welcome to Voting Machine. Please vote if not voted yet...!!!");
        String choice ="y";
        do{
            Block blockObj = null;
            String voterId = null;
            ...
            {
                System.out.println("Error: Reading line failed");
                return;
            }catch (Exception e){
                e.printStackTrace(); }
    ...
    public  SealedObject encrypt(Block b) throws  Exception{
        SecretKeySpec sks = new SecretKeySpec("MyDifficutlPassw".getBytes(), "AES");//use for encryption
        // Create cipher
