...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if (ch == 1)
        {
            ...
            System.out.println("server PORT -  The port to listen to; \"8777\" is default port");
            System.out.println("client SERVER_ADDRESS PORT- The server address and port to connect to; \"localhost:8777\" is default add ");
            System.out.println("Make sure you run the server first and then run client to connect to it");
            System.out.println(">------");
            ...
            else if(cmd[0].contains("c"))
            {
                ...
                /** Working as client */
                String svrAddr= DEFAULT_SERVER_ADDR;// If client wants to connect with server it needs server address and server port
